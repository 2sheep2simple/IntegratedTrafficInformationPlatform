        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:8080/loginIndex">首页 <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:8080/order/handle">订单管理</a>
                </li>
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:8080/car/match">车辆调度</a>
                </li>
                <li class="nav-item active">
            ...
            <form class="form-inline mt-2 mt-md-0">
                ...
                <button type="button" id="loginbtn" class="btn btn-primary" onclick="window.open('index')">退出登陆</button>
            </form>
        </div>
    </nav>
</header>
