...
<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
    <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">马钢物流-货物追踪</a>
    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            ...
            <div class="list-group">
                ...
                <p id="collapse3">
                    <button type="button" class="list-group-item list-group-item-action active">货物跟踪</button>
            ...
            <div id="table">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr v-for="(item,index) in newsList"><!-- v-for 指令需要以 site in sites 形式的特殊语法， sites 是源数据数组并且 site 是数组元素迭代的别名。 -->
                        ...
                        <td  width="10%"><span class="edit" onclick=window.open('http://localhost:8080/car/viewLocation')>查看位置</span></td>
                    </tr>
                    </tbody>
                </table>
                    ...
                    var vue =new Vue({
                        ...
                        methods:{
                            ...
                            viewLocation:function () {
                                // window.open("localhost:8080/car/viewLocation")
                                location.href="localhost:8080/car/viewLocation";
                            }
                        }
                    });
                    vue.init();
